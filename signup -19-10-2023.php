                ...
                <div class="col-12">
                    ...
                    <div class="contact-form">
                        ...
                        <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
                            ...
                            <input type="hidden" name="business" value="sb-147cbg27296033@business.example.com">
                            ...
                            <input type="hidden" name="first_name" id="customNameD" value="">
                            ...
                            <input type="hidden" name="return" value="http://localhost/dry_service/success.php">
                            <input type="hidden" name="cancel_return" value="http://localhost/dry_service/cancel.php">
