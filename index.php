...
<head>
    <meta charset="utf-8">
    <title>CARMIQUE - NYC Laundry Service</title>
...
<body>
        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Bronx, Brooklyn, Manhattan, and Queens</h4>
                            <h1 class="display-3 text-white mb-md-4">New York premier laundry service with 24hr Delivery
                            </h1>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Laundry & Free Delivery</h4>
                ...
                <div class="col-md-4 d-flex align-items-center justify-content-center bg-secondary mb-4 mb-lg-0"
                    ...
                    <div class="d-inline-flex">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0 text-white">Fordham Center Bronx, NY 10468 United States</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-items-center justify-content-center bg-primary mb-4 mb-lg-0"
                    ...
                    <div class="d-inline-flex text-left">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0 text-white">request@carmique.com</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-items-center justify-content-center bg-secondary mb-4 mb-lg-0"
                    ...
                    <div class="d-inline-flex text-left">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0 text-white">+1 716 919 7707</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container pt-0 pt-lg-4">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 mt-5 mt-lg-0 pl-lg-5">
                    ...
                    <h1 class="mb-4">Reinventing the future of laundry services in New York City.</h1>
                    <h5 class="font-weight-medium font-italic mb-4">CARMIQUE provides a reliable, speedy, and
                        professional laundry service that adjust to you individual needs.</h5>
                    <p class="mb-2">We collect, clean, and deliver your laundry to your doorstep. When and where you
                        need us, we will be there. We aim for our standard laundry service to be delivered the next day.
                    </p>
                    <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 pb-1">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center bg-light mb-4 px-4"
                        ...
                        <h4 class="font-weight-bold m-0">Duvets & Bulky Items</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 pb-1">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center bg-light mb-4 px-4"
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 m-0 my-lg-5 pt-0 pt-lg-5 pr-lg-5">
                    ...
                    <p>You should choose us for you laundry needs in New York City Area for the following reasons:
                    <p>1. By using our Service, you're making an eco-friendly choice. We use energy-efficient machines
                        and environmentally friendly detergents, reducing your carbon footprint.
                    <p>

                    <p>2. Say goodbye to laundry day! Our service frees up your valuable time, allowing you to foucs on
                        more productive things like spending with loved ones or pursuing your hobbies.
                    <p>

                    <p>3. We keep it simple for you! Just schedule a pickup, and our friendly team will handle the rest.
                        No more hassle of lugging heavy laundry bags or dealing with laundry machines.
                    <p>

                    <p>4. With our service, you can maintain a proffessional appearance effortlessly. We'll make sure
                        clothes are cleaned and ready for any important meeting or events.
                    <p>

                    <p>5.Let us take care of laundry, so you can take care of yourself. Enjoy the convenience and peace
                        of mind that comes with having clean, fresh clothes without the stress and effort.
                    <p>

                    <p>Give our service a try and experience the benefit firsthand.</p>
                    <div class="row">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center mb-5">
                        ...
                        <h3 class="font-weight-bold m-0 mt-2">Place an Order</h3>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center mb-5">
                        ...
                        <h3 class="font-weight-bold m-0 mt-2">Schedule a Pick-Up</h3>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center mb-5">
                        ...
                        <h3 class="font-weight-bold m-0 mt-2">Wait for our Courier</h3>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center mb-5">
                        ...
                        <h3 class="font-weight-bold m-0 mt-2">Free Delivery & Relax</h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="bg-light text-center mb-2 pt-4">
                        <div class="d-inline-flex flex-column align-items-center justify-content-center bg-secondary rounded-circle shadow mt-2 mb-4"
                            style="width: 240px; height: 240px; border: 10px solid #ffffff;">
                            <h3 class="text-white">Wash & Fold</h3>
                            <h1 class="display-4 text-white mb-0" id="priceOne">
                                <small class="align-top" style="font-size: 22px; line-height: 45px;">$</small>55<small
                                    class="align-bottom" style="font-size: 16px; line-height: 40px;">/ 30lbs</small>
                            </h1>
                        </div>
                        <div class="d-flex flex-column align-items-center py-3">
                            <p>Wash & Tumble Dry</p>
                            <p>Everyday Wears, T-shirt, trousers, bedsheets, undergarments.</p>
                            <p>Free Delievery</p>
                            <p>Serviced in 24hrs</p>
                        </div>
                        <a onclick="signUpButton(55);" href="#" class="btn btn-secondary py-2 px-4">Signup Now</a>
                    </div>
                </div>
                <div class="col-lg-4 mb-4">
                    <div class="bg-light text-center mb-2 pt-4">
                        <div class="d-inline-flex flex-column align-items-center justify-content-center bg-primary rounded-circle shadow mt-2 mb-4"
                            style="width: 261px; height: 261px; border: 10px solid #ffffff;">
                            <h3 class="text-white">Wash & Fold + Bulky Items</h3>
                            <h1 class="display-4 text-white mb-0" id="priceTwo">
                                <small class="align-top" style="font-size: 22px; line-height: 45px;">$</small>75<small
                                    class="align-bottom" style="font-size: 16px; line-height: 40px;">/ 30lbs</small>
                            </h1>
                        </div>
                        <div class="d-flex flex-column align-items-center py-3">
                            <p>Wash & Tumble Dry</p>
                            <p>Everyday wears + Duvets & Bulky Items</p>
                            <p>Free Delivery</p>
                            <p>Serviced in 24hrs</p>
                        </div>
                        <a onclick="signUpButton(75);" href="#" class="btn btn-primary py-2 px-4">Signup Now</a>
                    </div>
                </div>
                <div class="col-lg-4 mb-4">
                    <div class="bg-light text-center mb-2 pt-4">
                        <div class="d-inline-flex flex-column align-items-center justify-content-center bg-secondary rounded-circle shadow mt-2 mb-4"
                            style="width: 261px; height: 261px; border: 10px solid #ffffff;">
                            <h3 class="text-white">Dry Cleaning</h3>
                            <h1 class="display-4 text-white mb-0" id="priceThree">
                                <small class="align-top" style="font-size: 22px; line-height: 45px;">$</small>99<small
                                    class="align-bottom" style="font-size: 16px; line-height: 40px;">/ 15lbs</small>
                            </h1>
                        </div>
                        <div class="d-flex flex-column align-items-center py-3">
                            <p>Formalwear: Suits & Gowns</p>
                            <p>Pea & Sport Coats</p>
                            <p>Free Delivery</p>
                            <p>Serviced in 24 to 48 hrs</p>
                        </div>
                        <a onclick="signUpButton(99);" href="#" class="btn btn-secondary py-2 px-4">Signup Now</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    function signUpButton(value) {  
        if (value == 55) { 
            window.location.href = 'signup.php?price=' + value;
        } else if(value == 75) { 
            window.location.href = 'signup.php?price=' + value;
        } else { 
            window.location.href = 'signup.php?price=' + value;
    ...
    <div class="container-fluid bg-primary text-white mt-5 pt-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p>Say goodbye to laundry woes, reclaim your time and strike off chores. Live Life, we’ll handle your
                    Laundry</p>
